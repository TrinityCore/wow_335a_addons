...
L:RegisterTranslations("frFR", function()
    return {
		...
		["2.0 compatability"] = "Compatibilit\195\169 2.0",
		["If you're getting errors with table.setn, enable this"] = "Si vous obtenez des erreurs de type table.setn, activez ceci",
		...
		optInfoColor = "Couleur du texte d'information",
		optScale = "Echelle",
		...
		descInfoColor = "Change la couleur du texted'information",
		...
		linkallchanneldesc = "Montre automatiquement les loots dans %s lors d'un clique-gauche sur Montrer tout",
		}
end)