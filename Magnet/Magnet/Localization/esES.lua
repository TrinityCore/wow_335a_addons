local L = LibStub("AceLocale-3.0"):NewLocale("Magnet","esES")
...
L["Attract item"] = "Agregar objeto" -- Needs review
...
L["Clear item list"] = "Limpiar la lista de objetos" -- Needs review
...
L["Open GUI"] = "Abrir GUI" -- Needs review
L["Opens the configuration panel"] = "Abre la interfaz de configuración del AddOn" -- Needs review
-- L["party"] = ""
-- L["Party options"] = ""
-- L["Pick Pocket"] = ""
L["Prints detailed messages in the chat frame if, what, when and why it loots"] = "Muestra mensajes descriptivos en la ventana de chat de qué objetos toma, por qué y cuándo" -- Needs review
-- L["Prospecting"] = ""
-- L["raid"] = ""
-- L["Raid options"] = ""
...
L["Shows the list of current items to repel"] = "Mostrar mensajes descriptivos en la ventana de chat" -- Needs review
-- L["Show verbose messages in the chat frame"] = ""
-- L["Skillmode: looting %s"] = ""
-- L["Skinning"] = ""
-- L["solo"] = ""
-- L["Solo options"] = ""
L["Will clear the list of current items to search and autoloot for. THIS IS NOT UNDOABLE."] = "Limpia la lista de objetos que se deben buscar y lootear automáticamente. ESTO ES IRREVERSIBLE" -- Needs review
