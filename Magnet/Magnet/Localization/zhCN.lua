local L = LibStub("AceLocale-3.0"):NewLocale("Magnet","zhCN")
if not L then return end

L["Adds a new item to the attracted items list"] = "在自动拾取列表中增加一个物品" -- Needs review
...
L["Attract item"] = "增加物品" -- Needs review
...
L["Open GUI"] = "打开图形界面" -- Needs review
L["Opens the configuration panel"] = "打开Waterfall模式的图形配置界面" -- Needs review
-- L["party"] = ""
-- L["Party options"] = ""
-- L["Pick Pocket"] = ""
L["Prints detailed messages in the chat frame if, what, when and why it loots"] = "在聊天窗口输出详细的拾取信息，包括何时，在什么预设下，拾取了什么物品。" -- Needs review
-- L["Prospecting"] = ""
-- L["raid"] = ""
-- L["Raid options"] = ""
...
-- L["solo"] = ""
-- L["Solo options"] = ""
L["Will clear the list of current items to search and autoloot for. THIS IS NOT UNDOABLE."] = "将清空当前自动拾取列表，注意这是不可逆的！" -- Needs review
