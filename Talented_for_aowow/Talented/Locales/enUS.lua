...
L["Wowdb Talent Calculator"] = false
L["MMO Champion Talent Calculator"] = false
...
L["https://tcubuntu.northeurope.cloudapp.azure.com/aowow/?talent#%s"] = true
L["https://tcubuntu.northeurope.cloudapp.azure.com/aowow/?petcalc#%s"] = true
L["Send to ..."] = true
...
--~ L["Export the template as a URL to the official talent calculator"] = false
--~ L["Export the template as a URL to the wowhead talent calculator."] = true
--~ L["Export the template as a URL to the wowdb talent calculator."] = false
